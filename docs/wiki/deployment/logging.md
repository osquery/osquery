...
Status logs are generated by the [Glog logging framework](https://github.com/google/glog/). Glog writes these logs to disk. Logger plugins may also write status logs and write them to system or otherwise.
