...
!function(t, e) {
  "function" == typeof define && define.amd ? define(function() { return e(t) })
                                            : e(t)
}(this, function(t) {
  var e = function() {
    ...
    function q(t) {
      return a.call(t, function(t) { return null != t })
    }
    ...
    function B(t) {
      var e, n;
      return c[t] || (e = f.createElement(t), f.body.appendChild(e),
                      n = getComputedStyle(e, "").getPropertyValue("display"),
                      e.parentNode.removeChild(e), "none" == n && (n = "block"),
                      c[t] = n),
             c[t]
    }
    function U(t) {
      return "children" in t ? u.call(t.children)
    ...
    var e, n, r, i, O, P,
        o = [], s = o.concat, a = o.filter, u = o.slice, f = t.document, c = {},
        l = {}, h = {
          "column-count" : 1,
          columns : 1,
          "font-weight" : 1,
        ...
        b = f.createElement("table"), E = f.createElement("tr"), j = {
        ...
        w = /complete|loaded|interactive/, T = /^[\w-]*$/, S = {},
        C = S.toString, N = {}, A = f.createElement("div"), D = {
          tabindex : "tabIndex",
          readonly : "readOnly",
          "for" : "htmlFor",
          "class" : "className",
  ...
  return t.Zepto = e, void 0 === t.$ && (t.$ = e), function(e) {
    ...
    var r, n = 1, i = Array.prototype.slice, o = e.isFunction,
           s = function(t) { return "string" == typeof t }, a = {}, u = {},
           f = "onfocusin" in t, c = {focus : "focusin", blur : "focusout"},
           l = {mouseenter : "mouseover", mouseleave : "mouseout"};
    u.click = u.mousedown = u.mouseup = u.mousemove = "MouseEvents",
    e.event = {add : y, remove : x}, e.proxy = function(t, n) {
      ...
      if (s(n))
        return r ? (r.unshift(t[n], t), e.proxy.apply(null, r))
                 : e.proxy(t[n], t);
    ...
    var b = function() { return !0 }, E = function() { return !1 },
    ...
    e.fn.live = function(
        t, n) { return e(document.body).delegate(this.selector, t, n), this },
    e.fn.die = function(
        t, n) { return e(document.body).undelegate(this.selector, t, n), this },
    e.fn.on =
        function(t, n, a, u, f) {
      var c, l, h = this;
      return t && !s(t)
                 ? (e.each(t, function(t, e) { h.on(t, n, a, e, f) }), h)
                 : (s(n) || o(u) || u === !1 || (u = a, a = n, n = r),
                    (u === r || a === !1) && (u = a, a = r),
                    u === !1 && (u = E), h.each(function(r, o) {
                      f && (c = function(t) {
    ...
    e.fn.off =
        function(t, n, i) {
      var a = this;
      return t && !s(t) ? (e.each(t, function(t, e) { a.off(t, n, e) }), a)
                        : (s(n) || o(i) || i === !1 || (i = n, n = r),
                           i === !1 && (i = E),
                           a.each(function() { x(this, t, i, n) }))
    },
    e.fn.trigger =
        function(t, n) {
      return t = s(t) || e.isPlainObject(t) ? e.Event(t) : T(t), t._args = n,
             this.each(function() {
    ...
    var i, o, n = +new Date, r = t.document,
              ...
              u = /^(?:text|application)\/xml/i, f = "application/json",
    ...
    e.ajaxJSONP =
      ...
      var c, p, s = i.jsonpCallback,
                ...
                u = r.createElement("script"), f = t[a],
             ...
             e(u).on("load error",
                     function(n, r) {
                       clearTimeout(p), e(u).off().remove(),
                           ...
                           t[a] = f, c && e.isFunction(f) && f(c[0]),
                           f = c = void 0
                     }),
             v(h, i) === !1 ? (l("abort"), h)
                            : (t[a] = function() { c = arguments },
    ...
    e.ajaxSettings = {
      ...
      context : null,
      global : !0,
      xhr : function() { return new t.XMLHttpRequest },
      accepts : {
        script :
    ...
    e.ajax = function(n) {
      ...
      if (a && a.promise(N),
          ...
          (s.contentType ||
           s.contentType !== !1 && s.data && "GET" != s.type.toUpperCase()) &&
              b("Content-Type",
      ...
      return s.timeout > 0 && (P = setTimeout(function() {
                                 N.onreadystatechange = j, N.abort(),
