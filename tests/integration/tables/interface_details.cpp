...
TEST_F(InterfaceDetailsTest, test_sanity) {
  ...
  auto const row_map = ValidationMap{
    {"interface", NonEmptyString},
        ...
        {"metric", NonNegativeInt}, {"flags", NonNegativeInt},
        ...
        {"collisions", NonNegativeOrErrorInt}, {"last_change", IntType},
#ifdef OSQUERY_POSIX
        ...
        {"pci_slot", NormalType},
#endif
#if defined(OSQUERY_WINDOWS) || defined(APPLE)
        {"description", NormalType}, {"connection_id", NormalType},
        {"service", NormalType}, {"dhcp_enabled", NormalType},
        {"dhcp_server", NormalType}, {"dns_domain", NormalType},
        {"dns_server_search_order", NormalType},
#endif
#ifdef OSQUERY_WINDOWS
        {"friendly_name", NormalType}, {"manufacturer", NormalType},
        ...
        {"dhcp_lease_expires", NormalType}, {"dhcp_lease_obtained", NormalType},
