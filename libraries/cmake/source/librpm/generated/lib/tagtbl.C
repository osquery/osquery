static const struct headerTagTableEntry_s rpmTagTable[] = {
    ...
    { "RPMTAG_SUGGESTFLAGS", "Suggestflags", RPMTAG_SUGGESTFLAGS, RPM_INT32_TYPE, RPM_ARRAY_RETURN_TYPE, 1 },
    ...
    { "RPMTAG_SUGGESTVERSION", "Suggestversion", RPMTAG_SUGGESTVERSION, RPM_STRING_ARRAY_TYPE, RPM_ARRAY_RETURN_TYPE, 1 },
