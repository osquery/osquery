 ...
 * text to the results.
 *
 * @param key Bubble key containing the conversation and message identifiers.
 * @param value JSON-encoded bubble data.
 * @param path Path of the database containing the bubble.
 * @param results Collection to which the parsed chat entry is appended.
 */
