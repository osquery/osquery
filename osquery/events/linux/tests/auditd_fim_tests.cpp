...
const std::vector<std::pair<int, std::string>> raw_audit_event_record_list = {
    {AUDIT_SYSCALL,
     "audit(1501323932.707:7670507): arch=c000003e syscall=3 success=yes "
     "exit=0 a0=3 a1=0 a2=f a3=7f20e4218a10 items=0 ppid=1236 pid=2119 "
    ...
    {AUDIT_SYSCALL,
     ...
     "exit=0 a0=4 a1=6b8f20 a2=96b020 a3=9 items=0 ppid=1236 pid=2119 "
     "auid=1000 uid=1000 gid=1000 euid=1000 suid=1000 fsuid=1000 egid=1000 "
     "sgid=1000 fsgid=1000 tty=pts7 ses=34 comm=\"zsh\" exe=\"/usr/bin/zsh\" "
     "subj=unconfined_u:unconfined_r:unconfined_t:s0-s0:c0.c1023 key=(null)"},
    ...
    {AUDIT_SYSCALL,
     ...
     "exit=0 a0=a a1=0 a2=f a3=0 items=0 ppid=1236 pid=2119 auid=1000 uid=1000 "
    ...
    {AUDIT_SYSCALL,
     ...
     "exit=0 a0=d a1=0 a2=f a3=0 items=0 ppid=1236 pid=2119 auid=1000 uid=1000 "
     "gid=1000 euid=1000 suid=1000 fsuid=1000 egid=1000 sgid=1000 fsgid=1000 "
     "tty=pts7 ses=34 comm=\"zsh\" exe=\"/usr/bin/zsh\" "
     "subj=unconfined_u:unconfined_r:unconfined_t:s0-s0:c0.c1023 key=(null)"},
    ...
    {AUDIT_SYSCALL,
     ...
     "exit=0 a0=e a1=0 a2=f a3=0 items=0 ppid=1236 pid=2119 auid=1000 uid=1000 "
     "gid=1000 euid=1000 suid=1000 fsuid=1000 egid=1000 sgid=1000 fsgid=1000 "
     "tty=pts7 ses=34 comm=\"zsh\" exe=\"/usr/bin/zsh\" "
     "subj=unconfined_u:unconfined_r:unconfined_t:s0-s0:c0.c1023 key=(null)"},
    ...
    {AUDIT_SYSCALL,
     ...
     "exit=0 a0=f a1=0 a2=96bc71 a3=0 items=0 ppid=1236 pid=2119 auid=1000 "
    ...
    {AUDIT_SYSCALL,
     ...
     "exit=-9 a0=f a1=ac7570 a2=ac7570 a3=0 items=0 ppid=1236 pid=2119 "
     "auid=1000 uid=1000 gid=1000 euid=1000 suid=1000 fsuid=1000 egid=1000 "
     "sgid=1000 fsgid=1000 tty=pts7 ses=34 comm=\"zsh\" exe=\"/usr/bin/zsh\" "
     "subj=unconfined_u:unconfined_r:unconfined_t:s0-s0:c0.c1023 key=(null)"},
    ...
    {AUDIT_SYSCALL,
     ...
     "exit=-9 a0=e a1=ac7570 a2=ac7570 a3=0 items=0 ppid=1236 pid=2119 "
     "auid=1000 uid=1000 gid=1000 euid=1000 suid=1000 fsuid=1000 egid=1000 "
     "sgid=1000 fsgid=1000 tty=pts7 ses=34 comm=\"zsh\" exe=\"/usr/bin/zsh\" "
     "subj=unconfined_u:unconfined_r:unconfined_t:s0-s0:c0.c1023 key=(null)"},
    ...
    {AUDIT_SYSCALL,
     ...
     "exit=-9 a0=d a1=ac7570 a2=ac7570 a3=0 items=0 ppid=1236 pid=2119 "
     "auid=1000 uid=1000 gid=1000 euid=1000 suid=1000 fsuid=1000 egid=1000 "
     "sgid=1000 fsgid=1000 tty=pts7 ses=34 comm=\"zsh\" exe=\"/usr/bin/zsh\" "
     "subj=unconfined_u:unconfined_r:unconfined_t:s0-s0:c0.c1023 key=(null)"},
    ...
    {AUDIT_SYSCALL,
     ...
     "ppid=1236 pid=2119 auid=1000 uid=1000 gid=1000 euid=1000 suid=1000 "
    ...
    {AUDIT_SYSCALL,
     ...
     "exit=139954710917120 a0=0 a1=1000 a2=3 a3=22 items=0 ppid=1236 pid=2119 "
     "auid=1000 uid=1000 gid=1000 euid=1000 suid=1000 fsuid=1000 egid=1000 "
    ...
    {AUDIT_SYSCALL,
     ...
     "pid=2119 auid=1000 uid=1000 gid=1000 euid=1000 suid=1000 fsuid=1000 "
    ...
    {AUDIT_SYSCALL,
     ...
     "exit=139954710810624 a0=0 a1=19e73 a2=1 a3=2 items=0 ppid=1236 pid=2119 "
     "auid=1000 uid=1000 gid=1000 euid=1000 suid=1000 fsuid=1000 egid=1000 "
     "sgid=1000 fsgid=1000 tty=pts7 ses=34 comm=\"test\" "
     "exe=\"/home/user/test\" "
     "subj=unconfined_u:unconfined_r:unconfined_t:s0-s0:c0.c1023 key=(null)"},
    ...
    {AUDIT_SYSCALL,
     ...
     "exit=0 a0=3 a1=19e73 a2=1 a3=2 items=0 ppid=1236 pid=2119 auid=1000 "
     "uid=1000 gid=1000 euid=1000 suid=1000 fsuid=1000 egid=1000 sgid=1000 "
    ...
    {AUDIT_SYSCALL,
     ...
     "exit=0 a0=3 a1=7f49bed43698 a2=0 a3=31 items=0 ppid=1236 pid=2119 "
     "auid=1000 uid=1000 gid=1000 euid=1000 suid=1000 fsuid=1000 egid=1000 "
     "sgid=1000 fsgid=1000 tty=pts7 ses=34 comm=\"test\" "
     "exe=\"/home/user/test\" "
     "subj=unconfined_u:unconfined_r:unconfined_t:s0-s0:c0.c1023 key=(null)"},
    ...
    {AUDIT_SYSCALL,
     ...
     "exit=139954710806528 a0=0 a1=1000 a2=3 a3=22 items=0 ppid=1236 pid=2119 "
     "auid=1000 uid=1000 gid=1000 euid=1000 suid=1000 fsuid=1000 egid=1000 "
     "sgid=1000 fsgid=1000 tty=pts7 ses=34 comm=\"test\" "
     "exe=\"/home/user/test\" "
     "subj=unconfined_u:unconfined_r:unconfined_t:s0-s0:c0.c1023 key=(null)"},
    ...
    {AUDIT_SYSCALL,
     ...
     "exit=139954710798336 a0=0 a1=2000 a2=3 a3=22 items=0 ppid=1236 pid=2119 "
     "auid=1000 uid=1000 gid=1000 euid=1000 suid=1000 fsuid=1000 egid=1000 "
     "sgid=1000 fsgid=1000 tty=pts7 ses=34 comm=\"test\" "
     "exe=\"/home/user/test\" "
     "subj=unconfined_u:unconfined_r:unconfined_t:s0-s0:c0.c1023 key=(null)"},
    ...
    {AUDIT_SYSCALL,
     ...
     "exit=139954710913024 a0=0 a1=1000 a2=3 a3=22 items=0 ppid=1236 pid=2119 "
     "auid=1000 uid=1000 gid=1000 euid=1000 suid=1000 fsuid=1000 egid=1000 "
     "sgid=1000 fsgid=1000 tty=pts7 ses=34 comm=\"test\" "
     "exe=\"/home/user/test\" "
     "subj=unconfined_u:unconfined_r:unconfined_t:s0-s0:c0.c1023 key=(null)"},
    ...
    {AUDIT_SYSCALL,
     ...
     "exit=17 a0=1 a1=7f49bed42000 a2=11 a3=0 items=0 ppid=1236 pid=2119 "
     "auid=1000 uid=1000 gid=1000 euid=1000 suid=1000 fsuid=1000 egid=1000 "
     "sgid=1000 fsgid=1000 tty=pts7 ses=34 comm=\"test\" "
     "exe=\"/home/user/test\" "
     "subj=unconfined_u:unconfined_r:unconfined_t:s0-s0:c0.c1023 key=(null)"},
    ...
    {AUDIT_SYSCALL,
     ...
     "exit=10 a0=3 a1=a a2=400 a3=7ffcb2471410 items=0 ppid=1236 pid=2119 "
     "auid=1000 uid=1000 gid=1000 euid=1000 suid=1000 fsuid=1000 egid=1000 "
     "sgid=1000 fsgid=1000 tty=pts7 ses=34 comm=\"test\" "
     "exe=\"/home/user/test\" "
     "subj=unconfined_u:unconfined_r:unconfined_t:s0-s0:c0.c1023 key=(null)"},
    ...
    {AUDIT_SYSCALL,
     ...
     "exit=11 a0=3 a1=b a2=0 a3=7ffcb2471410 items=0 ppid=1236 pid=2119 "
     "auid=1000 uid=1000 gid=1000 euid=1000 suid=1000 fsuid=1000 egid=1000 "
     "sgid=1000 fsgid=1000 tty=pts7 ses=34 comm=\"test\" "
     "exe=\"/home/user/test\" "
     "subj=unconfined_u:unconfined_r:unconfined_t:s0-s0:c0.c1023 key=(null)"},
    ...
    {AUDIT_SYSCALL,
     ...
     "exit=41 a0=1 a1=7f49bed42000 a2=29 a3=5 items=0 ppid=1236 pid=2119 "
     "auid=1000 uid=1000 gid=1000 euid=1000 suid=1000 fsuid=1000 egid=1000 "
     "sgid=1000 fsgid=1000 tty=pts7 ses=34 comm=\"test\" "
     "exe=\"/home/user/test\" "
     "subj=unconfined_u:unconfined_r:unconfined_t:s0-s0:c0.c1023 key=(null)"},
    ...
    {AUDIT_SYSCALL,
     ...
     "a3=ffffffffffffff80 items=0 ppid=1236 pid=2119 auid=1000 uid=1000 "
     "gid=1000 euid=1000 suid=1000 fsuid=1000 egid=1000 sgid=1000 fsgid=1000 "
...
TEST_F(AuditdFimTests, test_syscall_parser) {
  std::vector<AuditEventRecord> event_record_list;

  for (const auto& record_descriptor : raw_audit_event_record_list) {
