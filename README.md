...
osquery is a set of operating system instrumentation products for *nix based hosts. osquery makes low-level operating system analytics and monitoring both performant and intuitive.
