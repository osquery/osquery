...
- Add additional chrome extensions paths ([#8170](https://github.com/osquery/osquery/pull/8170))
...
- Added cache and throttling for `certificates`, `keychain_acls`, and `keychain_items` tables. ([#8192](https://github.com/osquery/osquery/pull/8192))
- process_open_sockets: Mark pid column as additional instead of index ([#8191](https://github.com/osquery/osquery/pull/8191))

### Bug Fixes

- fix: Add stricter checks to JSON parsing ([#8229](https://github.com/osquery/osquery/pull/8229))
- Fix signed/unsigned mismatch in powershell_events ([#8225](https://github.com/osquery/osquery/pull/8225))
- fix: Fix a crash in firefox_addons ([#8227](https://github.com/osquery/osquery/pull/8227))
- fix: Correct the aws_sts_region behavior ([#8184](https://github.com/osquery/osquery/pull/8184))

### Documentation

- Update building.md prereqs for Windows ([#8216](https://github.com/osquery/osquery/pull/8216))
- docs: Correct link to a PR in the 4.7.0 changelog ([#8186](https://github.com/osquery/osquery/pull/8186))
- docs: Call out in the CHANGELOG the format changes of the status logs decorations ([#8174](https://github.com/osquery/osquery/pull/8174))
- docs: Remove some duplicated lines from 5.8.1 changelog ([#8172](https://github.com/osquery/osquery/pull/8172))
...
- ci: Fix Linux build ([#8208](https://github.com/osquery/osquery/pull/8208))
- ci: Correct job order ([#8185](https://github.com/osquery/osquery/pull/8185))
- test: re-enable tools_tests_testrelease ([#8221](https://github.com/osquery/osquery/pull/8221))
- tests: Enable client certificate verification in the TLS tests ([#8211](https://github.com/osquery/osquery/pull/8211))
- build: Temporary workaround to build with XCode 15 ([#8197](https://github.com/osquery/osquery/pull/8197))
