  ...
  if(DEFINED PLATFORM_LINUX)
    ...
    if(CPACK_GENERATOR STREQUAL "TGZ")
      if(CMAKE_SYSTEM_PROCESSOR STREQUAL "x86_64")
        ...
        set(CPACK_PACKAGE_FILE_NAME "${CPACK_PACKAGE_NAME}-${CPACK_PACKAGE_VERSION}_${OSQUERY_PACKAGE_RELEASE}_aarch64")
      endif()
    ...
    elseif(CPACK_GENERATOR STREQUAL "DEB")
      ...
      if(CMAKE_SYSTEM_PROCESSOR STREQUAL "x86_64")
        ...
        set(CPACK_DEBIAN_OSQUERY_FILE_NAME "${CPACK_PACKAGE_NAME}_${CPACK_PACKAGE_VERSION}_${OSQUERY_PACKAGE_RELEASE}.arm64.deb")
      endif()
      ...
      if(CMAKE_SYSTEM_PROCESSOR STREQUAL "x86_64")
        ...
        set(CPACK_DEBIAN_PACKAGE_DEPENDS "libc6 (>=2.23), zlib1g")
      endif()
    ...
    elseif(CPACK_GENERATOR STREQUAL "RPM")
      ...
      if(CMAKE_SYSTEM_PROCESSOR STREQUAL "x86_64")
        ...
        set(CPACK_PACKAGE_FILE_NAME "${CPACK_PACKAGE_NAME}-${CPACK_PACKAGE_VERSION}-${OSQUERY_PACKAGE_RELEASE}.aarch64")
      endif()
      ...
      if(CMAKE_SYSTEM_PROCESSOR STREQUAL "x86_64")
        ...
        set(CPACK_RPM_PACKAGE_REQUIRES "glibc >= 2.23, zlib")
      endif()
